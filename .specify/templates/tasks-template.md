...
**Tests**: The examples below include test tasks. Tests are **REQUIRED** per Constitution Principle III (Testing Standards). Every feature MUST include unit, integration, and — for UI layers — snapshot tests.
